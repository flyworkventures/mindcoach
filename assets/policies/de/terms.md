...
Textbasierter Chat mit künstlicher Intelligenz

Persönlichkeits- und Charakteroptionen für ein individuelles Erlebnis

Anleitende Gespräche zur Begleitung von täglichen Routinen, Gedanken und Emotionen

Vorschläge auf Basis des Nutzerverhaltens
...
Um die App nutzen zu können, gilt:

Sie müssen mindestens 13 Jahre alt sein.

Sie müssen korrekte und aktuelle Kontoinformationen angeben.

Sie dürfen die Inhalte der App nicht missbräuchlich verwenden.

Sie erkennen an, dass die mit der KI geführten Gespräche keine offizielle oder professionelle Beratung darstellen.

3. Verbotene Nutzungen

Folgende Verhaltensweisen sind untersagt:

Nutzung der App für rechtswidrige Aktivitäten

Vortäuschung oder Nachahmung realer Personen

Erstellung von Hassreden, Drohungen, Beleidigungen oder unangemessenen Inhalten

Unbefugter Zugriff auf das System, Hacking-Versuche oder Reverse Engineering

Manipulation der KI zur bewussten Irreführung

Verkauf, Vervielfältigung oder Weitergabe von App-Inhalten ohne Erlaubnis
...
Dürfen Sie Ihr Konto nicht mit Dritten teilen.

Liegt die Sicherheit Ihres Passworts in Ihrer Verantwortung.
...
Einige Funktionen können kostenpflichtig sein. Beim Erwerb dieser Dienste gilt:

Die Preisgestaltung richtet sich nach den Richtlinien des App Stores bzw. Google Play.

Abonnements können sich am Ende des Abrechnungszeitraums automatisch verlängern.
...
Nutzer verwenden die erhaltenen Antworten in eigener Verantwortung.

Die App ist kein Notfall- oder Kriseninterventionssystem. In solchen Fällen müssen sich Nutzer an die zuständigen offiziellen Stellen wenden.
...
Inhalte zu verkaufen oder weiterzuverteilen

Quellcode zu untersuchen oder zu verändern
...
Diese Nutzungsbedingungen anpassen

Änderungen treten in Kraft, sobald sie innerhalb der App veröffentlicht werden.
...
Fehlgebrauch oder missbräuchliche Nutzung der App

Probleme im Zusammenhang mit Gerät, Verbindung oder Internetzugang

Störungen, die durch Drittanbieter-Dienste verursacht werden

Der Nutzer akzeptiert, die App „wie gesehen“ („as is“) zu verwenden.
...
Betrügerisches oder böswilliges Verhalten

Erstellung unangemessener Inhalte

Sicherheitsverletzungen

Der Nutzer kann sein Konto jederzeit löschen und die Nutzung der App einstellen.

12. Anwendbares Recht

Diese Bedingungen unterliegen dem Recht der Republik Türkei.
Für Streitigkeiten sind die Zivilgerichte und Vollstreckungsbehörden in Istanbul (Zentralgerichte) zuständig.

13. Kontakt

Für alle Anfragen, Anliegen oder Mitteilungen:
