...
Kullanıcıya özel kişilik seçenekleri ve karakter deneyimleri


Günlük rutin, duygu ve düşünceleri takip etmeye yönelik yönlendirici konuşmalar
...
Yapay zekâ ile gerçekleştirilen sohbetlerin resmi veya profesyonel bir yönlendirme niteliği taşımadığını kabul edersiniz.
...
Gerçek kişileri taklit etmek


Nefret söylemi, tehdit, hakaret veya uygunsuz içerik üretmek


Sisteme izinsiz erişim sağlama, hack girişimi veya reverse engineering işlemleri


Yapay zekâyı manipüle ederek yanlış yönlendirme yapmak
...
Kullanıcı, aldığı yanıtları kendi sorumluluğunda kullanır.


Uygulama acil durum veya kriz müdahale sistemi değildir. Bu gibi durumlarda kullanıcılar ilgili resmi kurumlara başvurmalıdır.
...
Uygulamanın yanlış veya kötüye kullanımı


Cihaz, bağlantı veya internet sorunları


Üçüncü taraf hizmet sağlayıcılar kaynaklı aksaklıklar
...
Kullanıcı istediği zaman hesabını silebilir ve uygulamayı kullanmayı bırakabilir.
