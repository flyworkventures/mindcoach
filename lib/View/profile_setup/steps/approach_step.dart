...
// Eğer bu dosya profile_setup/widgets/ içindeyse:
...
class _ApproachStepState extends State<ApproachStep> {
  // Enum listesi
  final List<ApproachType> _options = ApproachType.values;

  late int _currentIndex;
  late FixedExtentScrollController _controller;

  int _indexForInitial() {
    // Dışarıdan gelen enum listede yoksa, default (Supportive)'e düş
    final externalIndex = _options.indexOf(widget.selectedApproach);
    if (externalIndex != -1) return externalIndex;

    final fallbackIndex =
    _options.indexOf(ApproachStrings.defaultApproach);
          ...
          child: ListWheelScrollView.useDelegate(
            ...
            childDelegate: ListWheelChildBuilderDelegate(
              ...
              builder: (context, index) {
                ...
                final label =
                ApproachStrings.label(context, _options[index]);
