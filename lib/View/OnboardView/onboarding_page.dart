...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
  ...
  void initState() {
    ...
    _autoTimer = Timer.periodic(const Duration(seconds: 4), (_) {
      if (!mounted) return;
      setState(() => _currentIndex = (_currentIndex + 1) % ref.read(AllControllers.onboardController.notifier).pages.length);
    });
  }
  ...
  Future<void> _handleSocialLogin(SocialLoginProvider provider) async {
    try {
      ...
      await ref.read(AllControllers.onboardController.notifier).login(provider,context);
              ...
              child: CrossFade<int>(
                ...
                builder: (context, index) {
                  return Align(
                    ...
                    child: Image.asset(
                    ref.read(AllControllers.onboardController.notifier).pages[index],
                      width: MediaQuery.of(context).size.width + 25,
                      fit: BoxFit.cover,
                    ),
                  );
                  ...
                  child: Column(
                    ...
                    children: [
                      OnboardingPageIndicator(
                        itemCount: ref.read(AllControllers.onboardController.notifier).pages.length,
