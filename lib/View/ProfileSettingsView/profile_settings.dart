                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            ref.read(AllControllers.pageSettingsController.notifier).updateUsername(name: _nameController.text.trim(), savedInfoText: l10n.save, context: context);
                            },
                              ...
                              child: _OutlineActionButton(
                                ...
                                onTap: () {
                                  showConfirmDialog(
                                    ...
                                    onConfirm: () async {
                                      // Logout işlemi
                                     ref.watch(AllControllers.pageSettingsController.notifier).logout();
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            _LegalLinkButton(
                              title: l10n.onboardingPrivacyPolicy,
                              onTap: () => _openUrl('https://fly-work.com/mindcoach/privacy-policy/'),
                            ),
                            const SizedBox(height: 12),
                            _LegalLinkButton(
                              title: l10n.onboardingTermsOfService,
