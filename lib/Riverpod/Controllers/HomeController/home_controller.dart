...
class HomeController extends StateNotifier<HomeViewModel> {
  ...
  void getMotivationText() async {
    ...
    if (json["data"]["motivation"] != null && json["data"]["tavsiye"] != null) {
      MotivationModel motivationModel = MotivationModel(
        json["data"]["motivation"],
        json["data"]["tavsiye"],
        json["data"]["reality"],
      );
      state = state.copyWith(
        ...
        texts: [
          _pageItem(
            text: motivationModel.motivationText ?? "",
            color: Colors.black,
          ),
          _pageItem(
            text: motivationModel.tavsiyeText ?? "",
            color: Colors.blueGrey,
          ),
          _pageItem(
            text: motivationModel.gercekText ?? "",
            color: Colors.indigo,
          ),
        ],
      );
...
class MotivationModel {
  ...
  MotivationModel copyWith({String? motivationText, String? tavsiyeText}) {
